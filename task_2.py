...
"""
Спец названий у большинства этих фигур вроде нет, что нагуглила, то поставила, так что тоже простой if
и отдельное 'agon' через f-сотроку, просто лень его писать.
"""
